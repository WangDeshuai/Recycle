...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        if ([self isKong]) {
            cell.lab2.hidden=NO;
            cell.lab.text=_model.userName;//_model.userName;
            cell.vipName.hidden=NO;
            cell.vipName.text=_model.vipClass;
           ...
           CGFloat g= [Engine getWidthWithFontSize:16 height:34 string:_model.userName];
            cell.lab.frame=CGRectMake(125, 20, g, 34);
            cell.vipName.frame=CGRectMake(g+125+10, 20, 100, 34);
