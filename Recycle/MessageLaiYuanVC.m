...
@interface MessageLaiYuanVC ()
@property(nonatomic,retain)NSMutableArray * dataArr;
@end

@implementation MessageLaiYuanVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self danghang];
    _dataArr=[[NSMutableArray alloc]initWithObjects:@"不限",@"普通会员",@"高级会员",@"企业会员", nil];
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    self.nameBlock(_dataArr[indexPath.row]);
...
-(void)danghang{
    ...
    [self.navigationItem setTitle:@"请选择来源"];
